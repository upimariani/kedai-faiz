                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-12">
                        <div class="form-block mx-auto">
                            ...
                            <form action="<?= base_url('pelanggan/clogin/lupapassword') ?>" method="post">
                                <div class="form-group last mb-3">
                                    <label for="password">Email</label>
                                    <input type="email" name="email" class="form-control" placeholder="Masukkan Email Anda" id="password1">
